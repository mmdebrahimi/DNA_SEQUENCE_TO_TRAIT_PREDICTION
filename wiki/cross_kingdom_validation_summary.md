...
| Bacteria | EBI AMR Portal independent (measured AST) | 21 SCORED_INDEPENDENT / 25 cells | BioSample/GCA disjoint vs CRyPTIC + tuning cohorts; measured wet-lab AST (non-circular); E.coli/Salmonella/Klebsiella/Shigella 0.83–0.995 acc | `wiki/amr_portal_independent_report_card.md` |
