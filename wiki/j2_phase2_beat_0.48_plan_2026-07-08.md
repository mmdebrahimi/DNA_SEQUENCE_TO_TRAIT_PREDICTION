...
| 2 | **Long-protein windowing** | `--long-mode window` | Recovers assays with proteins >1022 aa (currently DROPPED). **Completeness/honesty, NOT a guaranteed median lift** — long proteins may score lower; the number becomes more complete, not necessarily higher. | med (direction unknown by design) |
