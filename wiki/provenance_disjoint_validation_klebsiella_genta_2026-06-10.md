# Provenance-disjoint validation — Klebsiella x gentamicin — 2026-06-10

Deployed decoder `call_resistance(organism=Klebsiella, drug=gentamicin)` scored on a PROVENANCE-DISJOINT NCBI-PD subset (submitters OUTSIDE NARMS/CDC/FDA/GenomeTrakr/PulseNet/USDA).
