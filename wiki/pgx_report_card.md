...
| CYP2D6 | metabolizer phenotype (activity-score) — SNP surface only | 46/47 (0.9787) | — | — | 592/602 | hybrid IDENTITY (*13/*36/*68) unresolved (PSV analysis, Cyrius-class = v0.3); non-core SNP alleles (*14/*15/*21/*40/*46) mis-called (no sentinel v0). CN surface needs a BAM/CRAM |
