# Provenance-disjoint validation — Klebsiella x tetracycline — 2026-06-10

Deployed decoder `call_resistance(organism=Klebsiella, drug=tetracycline)` scored on a PROVENANCE-DISJOINT NCBI-PD subset (submitters OUTSIDE NARMS/CDC/FDA/GenomeTrakr/PulseNet/USDA).

## Result

| metric | value |
|---|---|
| n scored | 60 (TP 24 FP 1 TN 29 FN 6; abstain 0) |
| accuracy | 0.883 |
| sensitivity (R) | 0.8 |
| specificity (S) | 0.967 |
