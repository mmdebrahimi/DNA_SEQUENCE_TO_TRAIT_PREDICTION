...
| epistasis characterization (joint vs additive) | B_molecular | CHARACTERIZED | 5 proteins x orders 2-6: joint ~= additive (delta ~+-0.005); 'grows with order' FALSIFIED | novel: joint can be MUCH worse OOD (F7YBW8/ParD delta -0.283, degrades with order); additive is robust |
