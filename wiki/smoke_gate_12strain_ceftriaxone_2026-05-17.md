# Smoke Gate — 12-strain ceftriaxone cohort (2026-05-17)
...
**Cohort:** `data\processed\gate_b_mini_cef_cohort.parquet` (12 strains, 6R/6S ceftriaxone)
**Drug:** ceftriaxone
...
|---|---:|---:|---:|---|
| NT-XGBoost (nucleotide_transformer) | 0.833 | 0.710 | 11 | 5R / 6S |
| k-mer (k=8) + XGBoost | 0.833 | 0.917 | 12 | 6R / 6S |

## Gap analysis

- NT-XGBoost AUROC: **0.833**
- Best classical baseline (k-mer (k=8) + XGBoost): **0.833**
- Gap: **+0.0 pp** (best_classical − NT)
