# Smoke Gate — 12-strain tetracycline cohort (2026-05-17)
...
**Cohort:** `data\processed\gate_b_mini_tet_cohort.parquet` (12 strains, 6R/6S tetracycline)
**Drug:** tetracycline
**Gap threshold:** ≥15 pp (NT-XGBoost AUROC ≥ best-classical AUROC − 15 pp)
**Verdict:** FAIL (NT obviously worse)

## Per-variant LOSO results

| Variant | AUROC | AUPRC | N | Label balance |
|---|---:|---:|---:|---|
| NT-XGBoost (nucleotide_transformer) | 0.400 | 0.545 | 11 | 6R / 5S |
| k-mer (k=8) + XGBoost | 0.722 | 0.746 | 12 | 6R / 6S |

## Gap analysis

- NT-XGBoost AUROC: **0.400**
- Best classical baseline (k-mer (k=8) + XGBoost): **0.722**
- Gap: **+32.2 pp** (best_classical − NT)
- Acceptance bar: gap < 15 pp → FAIL
