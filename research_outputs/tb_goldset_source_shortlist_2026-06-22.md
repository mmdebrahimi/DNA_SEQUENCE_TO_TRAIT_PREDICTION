...
| 3 | **NIAID TB Portals** | yes — "Sequenced DST" per specimen | ~3,305 genomes + SRA | free but **DAR + DUA** | ~3,305 | non-CRyPTIC consortium; overlap-check via SRA | **best powered option** (needs a free DUA signature) |
