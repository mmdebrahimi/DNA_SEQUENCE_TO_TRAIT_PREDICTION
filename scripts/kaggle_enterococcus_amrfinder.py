#!/usr/bin/env python
"""SELF-CONTAINED Kaggle CPU notebook: SRA-assemble + AMRFinder the AR-Bank E. faecium isolates.

The AR Bank deposits E. faecium as SRA reads ONLY (0 downloadable assemblies) -> the enterococcus_amr cell
...
-O Enterococcus_faecium -> save the full main.tsv to /kaggle/working. Scoring (parse Element symbols ->
call_efm_tetracycline / call_efm_ciprofloxacin -> vs CDC labels) is done LOCALLY in the repo (verifiable),
...
Outputs: /kaggle/working/<biosample>.amrfinder.tsv (17 files) + assembly_manifest.json.
~15 min/isolate (SRA fetch + skesa + amrfinder) x 17 ~= 4 h; fits the 12 h CPU limit.
"""
import json
import os
import subprocess
...
# 17-isolate union of the AR-Bank E. faecium doxycycline (8R/7S) + levofloxacin (10R/4S) label sets.
# AMRFinder yields ALL determinants per assembly, so one run scores both drugs downstream.
BIOSAMPLES = [
    "SAMN11953784", "SAMN11954004", "SAMN11954006", "SAMN11954007", "SAMN11954008",
    "SAMN11954010", "SAMN11954011", "SAMN15040082", "SAMN15040086", "SAMN15040088",
    "SAMN15040089", "SAMN15040091", "SAMN15040093", "SAMN15040101", "SAMN15040102",
    "SAMN15040105", "SAMN15040106",
]
