...
def main(argv=None):
    ...
    ap.add_argument("--mem-gb", type=int, default=12)
    ...
    for i, row in enumerate(rows, 1):
        ...
        try:
            ...
            failed.append((iso, run, str(e)[:120]))
