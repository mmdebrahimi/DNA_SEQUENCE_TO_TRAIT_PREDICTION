"""A DETERMINISTIC genotype->phenotype dataset-candidate scorecard.

Scores a candidate dataset against the 8 quality gates distilled from this project's negative-results map +
embedding-niche 3-part test + horse-coat joinability lesson. Pure logic, no I/O — research fills in the
...
overall PASS, but tracked separately so a follow-up sweep knows what to go verify).
"""
