...
TRAITS = {
    ...
    "coatcolor": {
        ...
        "validation": "deterministic epistatic curated-catalog rule (literature-anchored Little 1957 / Schmutz & Berryere; OMIA-sourced causal loci); reference-integrity biology-checked incl. the E-locus epistasis anchor a naive has-the-allele rule mis-calls (e/e is red/yellow even when K^B + b/b). PARTIALLY MEASURED (the only colour cell that is): per-individual scoring vs the free Darwin's Ark/Dryad cohort (N=1930 owner-reported coat colour + N=3277 canFam4 genotypes, doi:10.5061/dryad.83bk3jb4r; scripts/dog_coat_darwins_ark_validate.py) RAN 2026-07-30 -- black 160/161 = 0.994 is a real measured win, blue/grey 11/31 = 0.355, and EVERY OTHER BASE COLOUR IS UNSCORABLE ON THAT SUBSTRATE because the causal variants are indels/structural (K^B 3bp del, ASIP SINE, MLPH d3 frameshift) or fell in an imputation gap (MC1R e) -- absent from a biallelic-SNV panel. So the rule is a textbook lookup that has been measured on ONE colour, not a validated multi-colour decoder (wiki/dog_coat_darwins_ark_measured_2026-07-30 + wiki/colour_cell_substrate_screen_2026-08-26). Calls COLOUR not shade/length/spotting; pattern loci (merle/spotting) ABSTAIN. Companion-animal, NOT human/forensic",
    },
    "morphology": {
    ...
    "rabbitcolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (classic rabbit A-E series); reference-integrity biology-checked incl. anchors a naive rule mis-calls (albino c/c masks all; e/e red hides agouti; Ed self-black). KNOWLEDGE_BASELINE: no free per-individual validation substrate. Companion/lab-animal, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): UNVALIDATABLE AS WRITTEN -- none of its 5 loci record a causal variant (the catalog names allele symbols and dominance order only), so no genotype file can be scored against this rule and NO COHORT WOULD HELP; the blocker is curation, not data. Gate G9. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "mousecolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (the century-old mouse pigment genetics); reference-integrity biology-checked (albino c/c masks; e/e yellow hides agouti). KNOWLEDGE_BASELINE. Lab-animal, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): UNVALIDATABLE AS WRITTEN -- none of its 6 loci record a causal variant (the catalog names allele symbols and dominance order only), so no genotype file can be scored against this rule and NO COHORT WOULD HELP; the blocker is curation, not data. Gate G9. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "cattlecolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (MC1R ED/E+/e; PMEL Dc/Dh dosage dilution); reference-integrity biology-checked (ED dominant black; e/e red; PMEL incomplete-dominant). KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): UNVALIDATABLE AS WRITTEN -- none of its 2 loci record a causal variant (the catalog names allele symbols and dominance order only), so no genotype file can be scored against this rule and NO COHORT WOULD HELP; the blocker is curation, not data. Gate G9. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "pigcolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (KIT dominant white epistatic over MC1R E-series); reference-integrity biology-checked (KIT I masks; ED black; e/e red). KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): UNVALIDATABLE AS WRITTEN -- none of its 2 loci record a causal variant (the catalog names allele symbols and dominance order only), so no genotype file can be scored against this rule and NO COHORT WOULD HELP; the blocker is curation, not data. Gate G9. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "sheepcolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (OMIA 000201-9940 agouti; ASIP dominant-white duplication vs recessive-black LOF; MC1R ED dominant black); reference-integrity biology-checked incl. ED-overrides-ASIP-white. KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): UNVALIDATABLE AS WRITTEN -- none of its 2 loci record a causal variant (the catalog names allele symbols and dominance order only), so no genotype file can be scored against this rule and NO COHORT WOULD HELP; the blocker is curation, not data. Gate G9. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "camelcolor": {
        ...
        "validation": "deterministic curated OMIA rule (MC1R dominant-white / ASIP recessive-black, Almathen 2018 / Alshanbari 2019); reference-integrity biology-checked. KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): PARTIAL -- 1/2 are indel/structural and off-panel for a SNP array (gate G10); only 1/2 loci are SNV-tractable, so a cohort could score part of this rule at best. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "minkcolor": {
        ...
        "validation": "deterministic curated OMIA rule (TYR albino nonsense; TYRP1 Palomino intron-2 insertion; MLPH Silverblue splice c.901+1G>A); reference-integrity biology-checked. KNOWLEDGE_BASELINE. Fur-farm animal, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): PARTIAL -- 1/3 loci record NO causal variant (gate G9); 1/3 are indel/structural and off-panel for a SNP array (gate G10); only 1/3 loci are SNV-tractable, so a cohort could score part of this rule at best. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "roedeercolor": {
        ...
        "validation": "deterministic curated OMIA rule (ASIP c.33G>T; TT black / GG-GT chestnut, Reissmann 2020); reference-integrity biology-checked. KNOWLEDGE_BASELINE. Wildlife, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): screened CLEAR on gates G9+G10 -- all 1/1 loci record an SNV causal variant, so this rule IS scoreable against an ordinary SNP panel if a free cohort appears. Still unmeasured (KNOWLEDGE_BASELINE). See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "guineapigcolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule; reference-integrity biology-checked. KNOWLEDGE_BASELINE. Lab/companion animal, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): PARTIAL -- 3/5 loci record NO causal variant (gate G9); 2/5 are indel/structural and off-panel for a SNP array (gate G10); only 0/5 loci are SNV-tractable, so a cohort could score part of this rule at best. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "foxcolor": {
        ...
        "validation": "deterministic curated OMIA rule (Vage 1997 non-epistatic ASIP x MC1R); reference-integrity biology-checked (Alaska + Standard silver both black via different loci; wild red). KNOWLEDGE_BASELINE. NOT human/forensic SUBSTRATE SCREEN (2026-08-26): PARTIAL -- 1/2 loci record NO causal variant (gate G9); 1/2 are indel/structural and off-panel for a SNP array (gate G10); only 0/2 loci are SNV-tractable, so a cohort could score part of this rule at best. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "donkeycolor": {
        ...
        "validation": "deterministic curated OMIA rule; reference-integrity biology-checked (grey-dun light-points / solid-black / red / Asinara albino). ASIP heterozygote variability -> a residual gene is unidentified (documented). KNOWLEDGE_BASELINE. NOT human/forensic SUBSTRATE SCREEN (2026-08-26): screened CLEAR on gates G9+G10 -- all 3/3 loci record an SNV causal variant, so this rule IS scoreable against an ordinary SNP panel if a free cohort appears. Still unmeasured (KNOWLEDGE_BASELINE). See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "buffalocolor": {
        ...
        "validation": "deterministic curated OMIA rule (LINE-1 ASIP dominant-white; convergent with cattle); reference-integrity biology-checked. KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): NO locus is SNV-tractable -- all 1/1 recorded causal variants are indel/structural, absent from any biallelic-SNV panel. Gate G10. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "goatcolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (ASIP dominant-white/tan vs recessive-black; TYRP1 brown); reference-integrity biology-checked. Goat MC1R association is incomplete in the literature so ASIP is the modeled driver. KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): PARTIAL -- 1/2 loci record NO causal variant (gate G9); 1/2 are indel/structural and off-panel for a SNP array (gate G10); only 0/2 loci are SNV-tractable, so a cohort could score part of this rule at best. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "alpacacolor": {
        ...
        "validation": "deterministic curated OMIA epistatic rule (MC1R E/e camelid recessive-white; ASIP fawn-vs-black); reference-integrity biology-checked incl. the ee-recessive-white anchor (white regardless of ASIP). KNOWLEDGE_BASELINE. Livestock, NOT human/forensic SUBSTRATE SCREEN (2026-08-26): UNVALIDATABLE AS WRITTEN -- none of its 2 loci record a causal variant (the catalog names allele symbols and dominance order only), so no genotype file can be scored against this rule and NO COHORT WOULD HELP; the blocker is curation, not data. Gate G9. See wiki/colour_cell_substrate_screen_2026-08-26.",
    },
    "pigeoncolor": {
